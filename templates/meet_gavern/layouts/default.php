...
if(isset($sidebarRules[$option]) || isset($sidebarRules[$ItemId])) {
	if(isset($sidebarRules[$ItemId])) {
		if($sidebarRules[$ItemId]->position == 'left') {
			$this->API->addCSSRule('#gk-content { float: right} #sidebar { margin: 0 0.5641% 0 0}');
		}
...
<body<?php if($this->browser->get("tablet") == true) echo ' data-tablet="true"'; ?><?php if($this->browser->get("mobile") == true) echo ' data-mobile="true"'; ?>>
	...
	<header>
        <div class="container-fluid">
            ...
            <div class="nav-top">
                <?php if($this->API->modules('bar-red')) : ?>
                ...
                <section id="bar-red">
                    ...
                    <div class="bar-red">
                        <jdoc:include type="modules" name="bar-red" style="none" />
                    </div>
                </section>
                <?php endif; ?>
            </div>
	...
	<section id="gk-main">
		<section class="container-fluid">
			...
			<section class="gk-content-wrap row-fluid">
				<section id="gk-content" class="span<?php echo $span;?> tspan<?php echo $span;?>">
	...
	<footer class="container-fluid">
        <section class="row-fluid">
            ...
            <?php if($this->API->get('copyrights', '') == '') : ?>
                &copy; <?php echo date('Y');?> <a href="http://www.cue.sjd.es" title="Centro Universitario de Enfermer&iacute;a San juan de Dios">Centro Universitario de Enfermer&iacute;a San juan de Dios. Provincia Bética.</a><a href="<?php echo $current_url; ?>#top" id="toTop"></a> 
            <?php else : ?>
