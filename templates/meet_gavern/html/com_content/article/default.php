...
?>
	<div itemprop="articleBody">
        <?php  if (isset($images->image_fulltext) and !empty($images->image_fulltext)) : ?>
            ...
            <div class="span4 margin-right-15"> 
                <a href="<?php echo htmlspecialchars($images->image_fulltext); ?>" data-modal-title="<?php echo htmlspecialchars($images->image_fulltext_alt); ?>" title="<?php echo htmlspecialchars($images->image_fulltext_alt); ?>" class="modal_link cboxElement articleimg">
                <img
