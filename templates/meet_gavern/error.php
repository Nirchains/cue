...
if($templateParams->get('webmaster_contact_type', 'email') == 'email') {
	...
	preg_match($pattern, '<a href="mailto:'.$webmaster_email.'">'.'Contacta con el webmaster'.'</a>', $regs, PREG_OFFSET_CAPTURE);
		    ...
		    <div id="frame">
		        <div id="errorDescription">
                    ...
                    if (($this->error->getCode()) == '404') {
                        header('Location: /index.php?option=com_content&view=article&id=247');
                        exit;
                        }    
                    ?>
		            </h2>
		        ...
		        <div id="errorboxbody">
		            <a class="icon-home" href="<?php echo $this->baseurl; ?>/index.php" title="<?php echo JText::_('JERROR_LAYOUT_GO_TO_THE_HOME_PAGE'); ?>">Página de inicio</a>
